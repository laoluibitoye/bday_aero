 ...
 *
 * Calendar-driven browse of any day's "Today's Paper" marked posts —
 * templates/template-todays-paper.php's date-picker sibling, sharing the
 * exact same query (bday_todays_paper_posts_for_date(), addons/todays-
 * paper/includes/query.php) and card markup
 * (bday_todays_paper_render_masonry()) so "today" and "any date here"
 * can never show different content for the same calendar day.
...
$bday_epaper_posts = bday_todays_paper_posts_for_date( $bday_epaper_year, $bday_epaper_month, $bday_epaper_day );
?>
<section class="bday-todays-paper-page bday-epaper-articles-page">
	<div class="bday-container">
		...
		<?php bday_todays_paper_render_calendar( $bday_epaper_year, $bday_epaper_month, $bday_epaper_ymd, get_permalink() ); ?>
