...
class Bday_Vendor_Ga4 extends Bday_Vendor_Driver {
	...
	public function settings_fields(): array {
		return array(
			array( 'key' => 'enabled', 'type' => 'checkbox', 'label' => 'Enable Google Analytics 4', 'default' => true ),
			array( 'key' => 'measurement_id', 'type' => 'text', 'label' => 'Measurement ID', 'default' => 'G-KRZW6E45JP' ),
