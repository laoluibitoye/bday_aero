...
require_once BDAY_THEME_DIR . 'core/homepage/class-section-content.php';
require_once BDAY_THEME_DIR . 'core/homepage/class-custom-sections.php';
require_once BDAY_THEME_DIR . 'core/homepage/class-section-registry.php';
require_once BDAY_THEME_DIR . 'core/homepage/section-sources.php';
require_once BDAY_THEME_DIR . 'core/homepage/hero-lead-lock.php';
require_once BDAY_THEME_DIR . 'core/homepage/data.php';
require_once BDAY_THEME_DIR . 'core/homepage/redesign-data.php';
